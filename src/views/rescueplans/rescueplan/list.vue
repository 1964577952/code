...
components: {
  ...
  methods: {
    ...
    getPageList() {
      ...
      this.query.m='and';
      getrescuePlanpage(this.query)
        .then(response => {
          //绑定分页列表
          this.list =  response.data.rescuePlanPage.list;
          this.total = response.data.rescuePlanPage.totalRow;
          //关闭load
