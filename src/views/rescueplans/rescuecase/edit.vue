...
export default {
  ...
  methods: {
    ...
    //获取默认数据
    fetchData(val) {
      editrescueCase({id:val})
        .then(response => {
           this.form=response.data.rescueCase;
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          this.isLoading = true;
           ...
           const params= "?rescueCase.accidentTypeId="+this.form.accidentTypeId
          +"&rescueCase.id="+ this.form.id
          +"&rescueCase.level="+ this.form.level
          +"&rescueCase.enterprisesType="+ this.form.enterprisesType
          +"&rescueCase.distressNum="+ this.form.distressNum
          +"&rescueCase.wreckNum="+ this.form.wreckNum
          +"&rescueCase.equipment="+ this.form.equipment
          +"&rescueCase.expert="+ this.form.expert
          +"&rescueCase.treatmentProcess="+this.form.treatmentProcess;
          
          updaterescueCase(params)
            .then(response => {
              this.$message({
                message: "操作成功",
                type: "success"
