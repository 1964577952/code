<template>
    <div class="app-container aside-container">
        ...
        <div class="filter-container" style="margin-top:20px;">
          <el-input placeholder="请输入计划类别进行搜索" v-model="query.keyword" class="input-with-select" style="width:50%;">
  ...
  methods: {
    ...
    getPageList() {
      ...
      getplanTypepage(this.query)
        .then(response => {
          //绑定分页列表
          this.list =  response.data.planTypePage.list;
          this.total = response.data.planTypePage.totalRow;
          //关闭load
