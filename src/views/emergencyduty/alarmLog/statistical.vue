        ...
        <div class="filter-container" style="margin-top:20px;">
            统计维度：
             <el-select  v-model="query.field"   slot="prepend" style="width:120px;" @change="change">
                    <el-option label="事故类型" value="type"></el-option>
                     <el-option label="事故等级" value="level"></el-option>
                      <el-option label="遇险人数" value="distressNum"></el-option>
                      <el-option label="遇难人数" value="wreckNum"></el-option>
                    </el-option>
                </el-select>
        </div>
        <div class="tabletitle">
