                ...
                <el-row :gutter="20">
                   <el-col :span="12">
                        <el-form-item label="遇险人数" >
                           <el-input-number v-model="form.distressNum"  :step="1" :min="1" :max="1000"></el-input-number>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="遇难人数" >
                           <el-input-number v-model="form.wreckNum"  :step="1"  :min="1" :max="1000"></el-input-number>
                        </el-form-item>
                    </el-col>
...
export default {
  data() {
    ...
    return {
      ...
      form: Object.assign({}, defaultData), //表单信息,初始化列表的时候为空
      isLoading: false,
      rules: {
           company: [
