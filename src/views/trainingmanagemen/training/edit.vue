                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="训练时长(H)" >
                           <el-input-number v-model="form.duration" :precision="1" :step="0.5" :max="100"></el-input-number>
                        </el-form-item>
                    </el-col>
                      <el-col :span="12">
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="应到人数" >
                           <el-input-number v-model="form.should"  :step="1" :max="1000"></el-input-number>
                        </el-form-item>
                    </el-col>
                     <el-col :span="12">
                        <el-form-item label="实到人数" >
                           <el-input-number v-model="form.actual"  :step="1" :max="1000"></el-input-number>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row :gutter="20">
                    <el-col :span="24">
                        <el-form-item label="缺席人" >
                            <el-input v-model="form.absent" placeholder="请输入训练类别"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
