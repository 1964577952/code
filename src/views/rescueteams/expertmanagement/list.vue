<template>
    <div class="app-container aside-container">
        ...
        <div class="filter-container" style="margin-top:20px;">
           <el-input placeholder="请输入姓名/手机号/学历/专业/联系地址...进行搜索" v-model="query.keyword" class="input-with-select" style="width:50%;">
        ...
        <el-table max-height="500"  style="margin-top:10px;" :data="list" v-loading.body="listLoading"  @selection-change="handleSelectionChange" element-loading-text="Loading" fit highlight-current-row>
             <el-table-column
            type="selection"
...
components: {
  ...
  methods: {
    ...
    getPageList() {
      ...
      //根据查询条件获取分页数据
      getexpert(this.query)
        .then(response => {
          //绑定分页列表
          this.list =  response.data.expertPage.list;
          //绑定数据总数用于分页控件
          this.total = response.data.expertPage.totalRow;
          //关闭load
